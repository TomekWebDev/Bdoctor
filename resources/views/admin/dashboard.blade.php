            ...
            <div class="d-flex align align-items-center">
                ...
                <div class="btn-group mr-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right dropdown-menu-lg-right">
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ route('admin.messages.index', $profile->id) }}">Messaggi
                                ricevuti</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#" class="dropdown-item text-danger" onclick="deleteProfile()">Elimina
                                profilo</a>
                        </li>
                        <form class="d-none" id="activeDelete" action="{{ route('admin.profile.destroy', $profile->id) }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
                        </form>
            ...
            <div class="col-sm-8">
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <div class="text-muted mt-1">Indirizzo: <span class="text-black">{{ $profile->address }}</span>
                        </div>
                        @if ($profile->phone)
                            <div class="text-muted mt-1">Telefono: <span class="text-black">{{ $profile->phone }}</span>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="card mt-3 p-2 ">
                    <div class="card-body">
                        <a class="btn btn-outline-primary btn-sm btn-block"
                            href="{{ route('admin.profile.edit', $profile->id) }}">Modifica Profilo</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @if ($profile->resume)
                        <embed src="{{ asset("Storage/$profile->resume") }}" class="img-fluid w-100 h-100"
