            ...
            <div class="row">
                <div class="col-lg-4 col-md-12">
                    <div class="card my-3 p-2">
                        ...
                        <div class="collapse" id="messagesDropdown">
                        ...
                        <p>
                            <button style="background-color: #076dbb" class="btn btn-primary w-100" type="button"
                                data-bs-toggle="collapse" data-bs-target="#reviewsDropdown" aria-expanded="false"
                                aria-controls="reviewsDropdown">
                        ...
                        <div class="collapse" id="reviewsDropdown">
                            <div class="card card-body mb-3">
                                <ReviewSender />
                                <div class="font-italic">
                                    I campi contrassegnati con
                        ...
                        <p>
                            <button style="background-color: #076dbb" class="btn btn-primary w-100" type="button"
                                data-bs-toggle="collapse" data-bs-target="#ratingsDropdown" aria-expanded="false"
                                aria-controls="ratingsDropdown">
                        ...
                        <div class="collapse" id="ratingsDropdown">
                            <div class="card card-body mb-3">
                                <RatingSender />
                                <div class="font-italic">
                                    I campi contrassegnati con
